...
This code base takes the peripherals_hids_mouse (BLE) code template. Modifies it to make button 1, on the DK board, a latching button for the mouse one button.
